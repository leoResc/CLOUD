...
public class DashboardTest {
	 ...
	 public void CheckDeleteSameSongs() {
		 ...
		 List<Song> gotSongs = controllers.Dashboard.deleteSameSongs(allSongs, deleteSongs);
	 ...
	 public void CheckGetSong(){
		 play.mvc.Result result = 
				 Helpers.callAction(controllers.routes.ref.Dashboard.getSong(), new FakeRequest("GET","/"));
	 }
}
